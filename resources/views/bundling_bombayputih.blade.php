...
<head>
    ...
    <title>Bundling Bawang Bombay dan Bawang Putih</title>
...
@endif
    ...
    <div class="deskripsi">
        ...
        <hr>
        <ul>
            <li>Bawang Bombay yang dijual murni berasal dari Probolinggo</li>
   ...
   <!--footer-->
    ...
    <script>
        // Ambil semua tombol "Tambahkan"
        const tambahkanButtons = document.querySelectorAll('.tambahkan');
    
        // Tambahkan event listener untuk setiap tombol
        tambahkanButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                .then(response => {
                    if (response.ok) {
                        ...
                        // Tangkap pesan error dari respon
                        response.json().then(data => {
                            console.error('Error:', data);
                            alert('Gagal menambahkan produk ke keranjang. Periksa konsol untuk detail kesalahan.');
                        });
                    }
                })
                .catch(error => {
