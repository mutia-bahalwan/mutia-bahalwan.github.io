...
@endif
    <div class="eceran">
        ...
        <div class="konten-hal3" id="productEceran">
            @foreach($products['Eceran'] as $product)
            <div class="isi-hal3">
                ...
                <form class="add-to-cart-form" action="{{ route('cart.store', ['productId' => $product->id]) }}" method="POST">
                    @csrf
    ...
    <div class="grosir">
        ...
        <div class="konten-hal3" id="productGrosir">
            @foreach($products['Grosir'] as $product)
            <div class="isi-hal3">
                <img src="{{ asset('uploads/'.$product->photo) }}" alt="{{ $product->product_name }}">
                <p class="bawang">{{ $product->product_name }}</p>
                <b class="harga">Rp {{ number_format($product->price, 0, ',', '.') }}<span class="kg">/1kg</span></b>
...
window.onload = () => {
    ...
    <div class="deskripsi">
        ...
        <ul>
            ...
            <li>Pembelian grosir dengan minimal pembelian 20kg</li>
            <li>Pembelian eceran dengan minimal pembelian 1kg</li>
        </ul>
    </div>
   <!--footer-->
    <footer>
